...
namespace
{
    ...
    GLint getMaxTextureUnits()
    {
        ...
        std::lock_guard<std::recursive_mutex> lock(maxTextureUnitsMutex);
...
struct Shader::UniformBinder
{
    ...
    DISABLE_COPY_MOVE_FUNC(UniformBinder);
...
{
    std::lock_guard<std::recursive_mutex> lock(isAvailableMutex);
